...
module.exports = function createShareClient(o,cb){
  ...
  console.log('share client initializing',o);
  ...
  if(!connections[connection_id]){
    ...
    console.log('connection created',connections[connection_id]);
  }
  ...
  if(!docs[doc_id]){
    ...
    console.log('doc created',docs[doc_id]);
  }
  var doc = docs[doc_id];
  
  console.log('doc instantiated',doc);

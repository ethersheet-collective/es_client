...
ExpressionHelpers.prototype.userFunctions = {};
  ...
  ExpressionHelpers.prototype.userFunctions.sum.name = "SUM(num1,num2,...)";
  ...
  ExpressionHelpers.prototype.userFunctions.product.name = "PRODUCT(num1,num2,...)";
  ...
  ExpressionHelpers.prototype.userFunctions.rand = function(num){
    return Math.random(num);
  };
  ExpressionHelpers.prototype.userFunctions.random = function(num){ return rand(num); };

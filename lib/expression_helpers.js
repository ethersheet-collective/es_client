...
ExpressionHelpers.prototype.setSheetCollection = function(sheet_collection){
  this.sheet_collection = sheet_collection;
  this.userFunctions.sheet_collection = this.sheet_collection;
};
...
ExpressionHelpers.prototype.preprocessFormula = function(formula,collection,id){
  console.log('preprocess', arguments);
  var sheet = this.sheet_collection.get(id);
...
ExpressionHelpers.prototype.userFunctions = {};
  ...
  ExpressionHelpers.prototype.userFunctions.cellreference = function(args){
    ...
    console.log('cellref', sheet_id, this.sheet_collection);
